# -*- coding: utf-8 -*-
#
# PyMVG documentation build configuration file, created by
...
latex_documents = [
  ('index', 'PyMVG.tex', u'PyMVG Documentation',
...
man_pages = [
    ('index', 'pymvg', u'PyMVG Documentation',
     [u'Andrew Straw'], 1)
]
...
texinfo_documents = [
  ('index', 'PyMVG', u'PyMVG Documentation',
   u'Andrew Straw', 'PyMVG', 'One line description of project.',
   'Miscellaneous'),
]
